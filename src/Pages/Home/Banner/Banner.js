    ...
    return (
        <div className='w-[95%] md:w-4/5 mx-auto flex flex-col-reverse md:flex-row justify-between items-center py-5'>
            <div className='w-full md:w-1/2 mt-12 md:mt-0'>
                <h2 className='text-center md:text-left text-3xl md:text-6xl font-semibold'>Welcome to<br /><span className='font-extrabold text-byteware-light-red text-5xl md:text-8xl'>Byteware</span></h2>
